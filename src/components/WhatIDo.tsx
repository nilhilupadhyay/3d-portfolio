        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Programming, Web, and AI/ML</h4>
              <p>
                I work across software engineering and machine learning with a
                focus on practical, production-oriented solutions.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">DeepSort</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                I build with strong computer science foundations and modern
                development tooling.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
